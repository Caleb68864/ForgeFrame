...
- [[kdenlive-avfilter-and-effect-zones]] — generic `avfilter.*` clip-filter shape (unblocks ~30 effects); native video fade-to-black; `kdenlive:zone_in/out` for clip-sub-range effects

...
def effect_frei0r_aech0r(
    ...
    try:
        ...
        svc.text = 'frei0r.aech0r'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_aech0r'

        params: dict[str, object] = {'0': _0, '1': _1, '2': _2, '3': _3, '4': _4}
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_aech0r",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_aech0r",
        )

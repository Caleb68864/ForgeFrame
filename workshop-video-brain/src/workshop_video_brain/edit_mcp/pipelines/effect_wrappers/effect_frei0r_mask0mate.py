...
Source effect: kdenlive_id=frei0r_mask0mate, mlt_service=frei0r.mask0mate
"""
...
def effect_frei0r_mask0mate(
    ...
    """Rectangular Alpha mask -- Creates an square alpha-channel mask."""
    try:
        ...
        svc.text = 'frei0r.mask0mate'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_mask0mate'

        params: dict[str, object] = {'Invert': Invert}
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_mask0mate",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_mask0mate",
        )

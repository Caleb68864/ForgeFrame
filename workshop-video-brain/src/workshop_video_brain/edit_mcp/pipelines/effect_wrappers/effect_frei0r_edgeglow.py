...
Source effect: kdenlive_id=frei0r_edgeglow, mlt_service=frei0r.edgeglow
"""
...
def effect_frei0r_edgeglow(
    ...
    try:
        ...
        svc.text = 'frei0r.edgeglow'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_edgeglow'
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_edgeglow",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_edgeglow",
        )

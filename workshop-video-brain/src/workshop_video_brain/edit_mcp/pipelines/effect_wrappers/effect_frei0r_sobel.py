...
Source effect: kdenlive_id=frei0r_sobel, mlt_service=frei0r.sobel
"""
...
def effect_frei0r_sobel(
    ...
    try:
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_sobel",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_sobel",
        )

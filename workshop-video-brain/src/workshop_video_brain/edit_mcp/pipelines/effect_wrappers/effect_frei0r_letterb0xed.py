...
def effect_frei0r_letterb0xed(
    ...
    try:
        ...
        svc.text = 'frei0r.letterb0xed'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_letterb0xed'

        params: dict[str, object] = {'Transparency': Transparency}
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_letterb0xed",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_letterb0xed",
        )

...
Source effect: kdenlive_id=frei0r_luminance, mlt_service=frei0r.luminance
"""
...
def effect_frei0r_luminance(
    ...
    try:
        ...
        svc.text = 'frei0r.luminance'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_luminance'
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_luminance",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_luminance",
        )

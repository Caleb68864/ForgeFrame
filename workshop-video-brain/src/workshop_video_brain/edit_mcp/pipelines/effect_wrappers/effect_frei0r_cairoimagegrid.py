...
def effect_frei0r_cairoimagegrid(
    ...
    try:
        ...
        svc.text = 'frei0r.cairoimagegrid'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_cairoimagegrid'
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_cairoimagegrid",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_cairoimagegrid",
        )

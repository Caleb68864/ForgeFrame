...
Source effect: kdenlive_id=frei0r_transparency, mlt_service=frei0r.transparency
"""
...
@register_effect_wrapper
def effect_frei0r_transparency(
    workspace_path: str,
    project_file: str,
    track: int,
    clip: int,
    ...
    try:
        ...
        svc.text = 'frei0r.transparency'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_transparency'
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_transparency",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_transparency",
        )

...
Source effect: kdenlive_id=frei0r_cluster, mlt_service=frei0r.cluster
"""
...
def effect_frei0r_cluster(
    ...
    """K-Means Clustering (ABANDONED) -- <b>Abandoned due to heavy CPU workload.</b><br>."""
    try:
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_cluster",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_cluster",
        )

...
Source effect: kdenlive_id=frei0r_tehroxx0r, mlt_service=frei0r.tehRoxx0r
"""
...
def effect_frei0r_tehroxx0r(
    ...
    try:
        ...
        svc.text = 'frei0r.tehRoxx0r'
        kid = ET.SubElement(filt, "property", {"name": "kdenlive_id"})
        kid.text = 'frei0r_tehroxx0r'
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_tehroxx0r",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_tehroxx0r",
        )

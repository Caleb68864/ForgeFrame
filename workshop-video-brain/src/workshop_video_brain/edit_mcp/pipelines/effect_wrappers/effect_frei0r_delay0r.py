...
Source effect: kdenlive_id=frei0r_delay0r, mlt_service=frei0r.delay0r
"""
...
def effect_frei0r_delay0r(
    ...
    try:
        ...
        create_snapshot(
            ws_path,
            project_path,
            description="before_effect_frei0r_delay0r",
        )
        patcher.insert_effect_xml(project, (track, clip), xml_string, insert_index)
        snap = create_snapshot(
            ws_path,
            project_path,
            description="after_effect_frei0r_delay0r",
        )
